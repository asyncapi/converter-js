...
lib.convert = (asyncapi, version, options = {}) => {
  ...
  // add 1 to `fromVersion` because we convert always from previous to next
  ...
  if (isYAML) converted = yaml.safeDump(converted, { skipInvalid: true });
  return converted;
};
...
function from__1_2_0__to__2_0_0_rc1(asyncapi1, options) {
...
function from__2_0_0_rc1__to__2_0_0_rc2(asyncapi2rc1, options) {
